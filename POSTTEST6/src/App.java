...
public class App {
    // Variabel static untuk melacak jumlah UMKM yang telah dibuat
    private static int counter = 0;

    // Metode static untuk menambahkan nilai counter
            ...
            try {
                ...
                switch (menu) {
                    ...
                    case 2 :
                        ...
                        ProdukUMKM usaha = new ProdukUMKM(idUMKM, namaUMKM, jenisUsaha, lokasiUMKM, jumlahKaryawan, "jenis produk", "nama pengelola", 123456, "email@example.com", 0, 0);
                        ...
                        incrementCounter(); // Memanggil metode static untuk menambahkan nilai counter
                        break;
                    case 3:
                        // Mengubah data UMKM
                ...
                System.out.println("Terjadi kesalahan saat membaca masukan.");
            }
        }
    }
}
