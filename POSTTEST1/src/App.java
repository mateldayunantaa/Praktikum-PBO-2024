        ...
        while(true){
            ...
            switch (menu) {
                ...
                case 2 :
                    ...
                    UMKM usaha = new UMKM(idUMKM, namaUMKM, jenisUsaha, lokasiUMKM, jumlahKaryawan);
                    KeuanganUMKM keuangan = new KeuanganUMKM(idUMKM, pendapatan, modalAwal, sumberModal);
                    ush.add(usaha);
